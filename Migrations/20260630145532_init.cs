        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FollowUpFee = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AppointmentStateChanges",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OldState = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentStateChanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppointmentStateChanges_Appointments_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentStateChanges_AppointmentId",
                table: "AppointmentStateChanges",
